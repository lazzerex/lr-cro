...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'plugins' => 'advlist autoresize codesample emoticons fullscreen image imagetools link lists media table wordcount code',
            'toolbar' => 'undo redo removeformat | formatselect | bold italic | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table | image link media codesample emoticons | fullscreen | code',
